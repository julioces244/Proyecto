...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombreInput = (Spinner) findViewById(R.id.nombre_input);
        precioInput = (EditText) findViewById(R.id.precio_input);
        detallesInput = (EditText) findViewById(R.id.detalles_input);

        nombreInput.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                                       int arg2, long arg3) {
                String text = nombreInput.getSelectedItem().toString();
                if (text.equalsIgnoreCase("Ejecutivo")) {
                    precioInput.setText("10.99");
                } else {
                    precioInput.setText("7.99");
                }
            }
    ...
    public void callRegister(View view) {
        ...
        String nombre = nombreInput.getSelectedItem().toString();
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createMenu(nombre, precio, detalles,1);
        } else {
